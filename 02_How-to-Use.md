...
## Two‑step usage flow (very simple)

You will always work in **two messages**:
...
## Step 1 – Describe your situation (Message 1)

In the **first message** to the AI, write in your own words:

- What is happening?  
- Where do you feel stuck or curious?  
- What would you like to change, understand, or see differently?

You can use one of these templates:

- “I feel stuck in my career because…”  
- “I keep repeating this pattern in relationships…”  
...
## Step 2 – Paste the Quantum Vision Prompt (Message 2)

In the **second message in the same chat**:

1. Copy the **entire Quantum Vision Prompt** text from your product.  
2. Paste it as **one single message**.  
3. Send it without adding extra text before or after.
...
- Asking you a few short clarifying questions.  
- Reframing your situation through the Quantum Vision lens.  
- Offering specific techniques and steps you can try.
...
1. **You (Message 1):**  
   > I feel blocked in my creative work. I have many ideas but don’t finish anything, and it makes me doubt myself.

2. **You (Message 2):**  
   > [Paste the full Quantum Vision Prompt here.]

3. **AI:**  
   - Asks 1–3 clarifying questions (about area of life, what success looks like, etc.).  
   - Explains your situation using Quantum Vision principles (interconnectedness, states, potentials, observer role).  
   - Suggests several “Quantum Techniques” (for example: superposition visualization, resonance filter, myth‑reframing).  
   - Gives 3–7 concrete actions for the next 24–72 hours.

If the AI answers in a generic way, you can reply:
...
## Best practices for powerful results
...
## Quick “cheat sheet” (for users in a hurry)

- Open AI chat.  
- **Message 1:** “Here is my situation: …” (write your problem or question).  
- **Message 2:** Paste the **full Quantum Vision Prompt**.  
- Answer AI’s clarifying questions.  
- Apply the steps and techniques it suggests.

---

## Notes for digital product creators

You may want to include this file as:  
